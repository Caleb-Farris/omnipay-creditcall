...
class ServerCompleteAuthorizeResponseTest extends TestCase
{
    ...
    {
        $response = m::mock('\Omnipay\Creditcall\Message\ServerCompleteAuthorizeResponse[sendResponse]');
    ...
    {
        $response = m::mock('\Omnipay\Creditcall\Message\ServerCompleteAuthorizeResponse[exitWith]');
